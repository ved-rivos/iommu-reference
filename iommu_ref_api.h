...
extern void iommu_translate_iova(hb_to_iommu_req_t req, iommu_to_hb_rsp_msg_t *rsp_msg);
extern void iommu_handle_message(hb_to_iommu_req_t req, iommu_to_hb_rsp_msg_t *rsp_msg);
