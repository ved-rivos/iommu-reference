...
extern void 
cache_iotlb(uint64_t addr, uint8_t  GV, uint8_t  PSCV, uint32_t GSCID, uint32_t PSCID,
...
extern uint8_t 
lookup_iotlb( uint64_t iova, uint8_t priv, uint8_t is_read, uint8_t is_write, uint8_t is_exec,
...
extern uint8_t 
lookup_ddt(uint32_t device_id, device_context_t *DC);

extern void 
cache_ddt(uint32_t device_id, device_context_t *DC);

extern uint8_t 
lookup_pdt(uint32_t device_id, uint32_t process_id, process_context_t *PC);

extern void
cache_pdt(uint32_t device_id, uint32_t process_id, process_context_t *PC);
